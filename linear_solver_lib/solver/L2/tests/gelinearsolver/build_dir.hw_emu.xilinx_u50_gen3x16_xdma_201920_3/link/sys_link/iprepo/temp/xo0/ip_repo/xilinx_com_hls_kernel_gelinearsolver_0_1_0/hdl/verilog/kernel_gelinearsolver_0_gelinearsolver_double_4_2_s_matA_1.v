...
module kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1_ram # (

  // Common module parameters
  parameter integer                 MEMORY_SIZE        = 512,
  ...
  parameter integer                 ADDR_WIDTH_A       = 3,
...
endmodule : kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1_ram
`timescale 1 ns / 1 ps
module kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1(
    reset,
    clk,
    address0,
    ce0,
...
kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1_ram kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1_ram_U(
    .clka( clk ),
    .clkb( clk ),
    .rsta( reset ),
    .rstb( reset ),
