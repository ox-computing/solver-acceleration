...
//--------------------------------------------------------------------------------
//Command: generate_target bd_8783.bd
//Design : bd_8783
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_8783,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_8783,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=38,numReposBlks=30,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "bd_b35e_interconnect_S00_AXI_0.hwdef" *) 
module bd_8783
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  m00_exit_pipeline_imp_V1TV6F m00_exit_pipeline
  ...
  m00_nodes_imp_HPXR97 m00_nodes
  ...
  m01_exit_pipeline_imp_XI5VIV m01_exit_pipeline
  ...
  m01_nodes_imp_196DKR1 m01_nodes
  ...
  s00_entry_pipeline_imp_1TOVG9G s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_1X7W1ZI s00_nodes
  ...
  switchboards_imp_14NYTCQ switchboards
...
module m00_exit_pipeline_imp_V1TV6F
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module m01_exit_pipeline_imp_XI5VIV
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module s00_entry_pipeline_imp_1TOVG9G
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_8783_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_8783_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_8783_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module switchboards_imp_14NYTCQ
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
