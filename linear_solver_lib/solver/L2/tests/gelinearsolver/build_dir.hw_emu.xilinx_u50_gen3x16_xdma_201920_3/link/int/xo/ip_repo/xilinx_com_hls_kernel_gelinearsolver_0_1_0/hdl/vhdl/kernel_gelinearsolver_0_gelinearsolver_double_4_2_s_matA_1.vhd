...
entity kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1_ram is 
   generic(
  -- Common module parameters
       MEMORY_SIZE        : integer := 512;
  ...
  -- Port A module parameters
       WRITE_DATA_WIDTH_A : integer := 64;
       READ_DATA_WIDTH_A  : integer := 64;
       BYTE_WRITE_WIDTH_A : integer := 64;
       ADDR_WIDTH_A       : integer := 3;
       READ_RESET_VALUE_A : string  := "0";
       READ_LATENCY_A     : integer := 2;
       WRITE_MODE_A       : string := "no_change";

  -- Port B module parameters
       WRITE_DATA_WIDTH_B : integer := 64;
       READ_DATA_WIDTH_B  : integer := 64;
       BYTE_WRITE_WIDTH_B : integer := 64;
       ADDR_WIDTH_B       : integer := 3;
...
architecture rtl of kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1_ram is 
...
entity kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1 is
    generic (
...
architecture arch of kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1 is
    component kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1_ram is
        port (
            clka : IN STD_LOGIC;
            clkb : IN STD_LOGIC;
            rsta : IN STD_LOGIC;
...
begin
    kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1_ram_U :  component kernel_gelinearsolver_0_gelinearsolver_double_4_2_s_matA_1_ram
    port map (
        clka => clk,
        clkb => clk,
        rsta => reset,
