...
#pragma HLS INTERFACE m_axi port = A_cols bundle = gmem1 offset = slave max_read_burst_length = 128
#pragma HLS INTERFACE m_axi port = A_vals bundle = gmem2 offset = slave max_read_burst_length = 128
#pragma HLS INTERFACE m_axi port = dataB bundle = gmem3 offset = slave max_read_burst_length = 128 max_write_burst_length = 128
